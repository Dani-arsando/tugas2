...
Widget cetakTextFoto(
        {double h = 500.0,
        double w = 600.0,
        var bgr = Colors.greenAccent,
        var txt = 'hai',
        var img = const NetworkImage(
            'https://raw.githubusercontent.com/Dani-arsando/myapp1/main/edge2edge-media-t1OalCBUYRc-unsplash.jpg')}) =>
    Container(
      height: h,
      width: w,
      color: bgr,
...
class Programnya extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    children: [
      ...
      spasi(h: 10.0),
      cetakTextFoto(
        txt: 'Hello Word\nHai Semuanya....\nPerkenalkan Nama Saya Dani Arsando'
      ),
    ],);
  }
}
